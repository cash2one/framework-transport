 ...
 */
public class ClientInitializeTask  implements Callable<Boolean> {
    ...
    ClientInitializeTask(EventLoopGroup eventLoopGroup, InetSocketAddress serverAddress, SerializeProtocol protocol) {
        ...
        channelFuture.addListener(new ChannelFutureListener() {
            public void operationComplete(final ChannelFuture channelFuture) throws Exception {
                if (channelFuture.isSuccess()) {
                    ...
                    ServerLoader.getInstance().setMessageSendHandler(handler);
                }
            }
        });
        return Boolean.TRUE;
